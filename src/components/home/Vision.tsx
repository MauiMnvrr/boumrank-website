      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        >
          ...
          <div className="relative z-10 py-16 md:py-20 px-8 md:px-16 text-center">
            ...
            >
              {isEn ? 'Tomorrow, your coupons will' : 'Demain, vos coupons'}{' '}
            ...
            >
              {isEn ? 'The BoumRank cross-promo marketplace — coming soon.' : 'La marketplace cross-promo BoumRank — le futur proche.'}
            </motion.p>
            ...
            >
              {isEn
                ? <>Imagine this: your customer wins a free coffee at your place. The following week, the wine shop next door gives them a reward <em className="text-white font-semibold">redeemable at yours</em>. You share customers, not competitors. That&apos;s the BoumRank cross-promo marketplace — being built for 2026 —{' '}<span className="text-white font-semibold">and early subscribers get first pick.</span></>
                : <>Imaginez un instant : votre client gagne chez vous un café offert. La semaine d&apos;après, le caviste d&apos;à côté le fait gagner <em className="text-white font-semibold">chez vous</em> sur sa propre roue. Vous partagez des clients, pas des concurrents. C&apos;est la marketplace cross-promo BoumRank, en cours de build pour 2026 —{' '}<span className="text-white font-semibold">et vos premiers abonnés auront la place de choix.</span></>
              }
            </motion.p>
            ...
            >
              {(isEn ? ['🍔 Your restaurant', "🍷 The wine shop next door", '💇 The salon down the street'] : ['🍔 Votre restaurant', "🍷 Le caviste d'à côté", '💇 Le salon du coin']).map(
                (label, i) => (
            ...
            >
              ...
              >
                {isEn ? 'Join the early subscribers' : 'Rejoindre les premiers abonnés'}
                <ArrowRight size={18} />
              </Button>
              <span className="text-white/70 text-xs font-display font-bold uppercase tracking-widest">
                {isEn ? 'Priority access to the marketplace' : 'Accès prioritaire à la marketplace'}
              </span>
            </motion.div>
          </div>
        </motion.div>
