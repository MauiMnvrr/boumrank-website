...
const advantages: Advantage[] = [
  {
    ...
    title: 'Le menu, c\'est l\'arme secrète',
    body: 'Nos concurrents diffusent leur jeu via QR code marketing isolé. Nous l\'intégrons au menu — qui est ouvert plusieurs fois par repas, pas une fois par campagne.',
  ...
  },
  {
    ...
    title: 'Le cashback se paie tout seul',
    body: 'Minimum d\'achat bas + coupon différé du lendemain. Le client revient et reconsomme bien au-delà de la valeur du coupon. La solution finance son propre abonnement.',
  ...
  },
  {
    ...
    title: 'Vous démarrez à midi, vous encaissez le soir',
    body: 'Branchez votre QR code en 2 minutes. Aucune intégration. Aucune formation. Aucune app à télécharger pour vos clients. Pas d\'agence à payer, pas de tech à attendre.',
