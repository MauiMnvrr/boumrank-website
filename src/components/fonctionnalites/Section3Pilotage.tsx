...
const advantages: Advantage[] = [
  {
    ...
    body: 'Nous sommes les seuls à digitaliser votre menu sans vous facturer d\'abonnement supplémentaire. C\'est pour nous, c\'est cadeau, et ça nous fait vraiment plaisir !',
  ...
  },
  {
    ...
    body: 'Fixez un minimum d\'achat pour le retrait des lots. Le client revient, consomme à nouveau et notre solution s\'auto-finance. Max d\'avis, aucune sortie !',
  ...
  },
  {
    ...
    body: 'Nos concurrents diffusent leur jeu via un QR code isolé. Grâce à notre intégration, ce n\'est pas 1 client sur 5 qui joue, mais 1 sur 3. Plus de joueurs, plus d\'avis pour le même nombre de clients.',
