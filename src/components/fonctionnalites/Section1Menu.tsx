      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-[var(--text-secondary)] leading-relaxed">
            Vos clients consultent le menu pour choisir leur plat.{' '}
            <span className="text-[var(--text-primary)] font-semibold">
              Ils découvrent qu&apos;ils peuvent gagner.
            </span>
          </p>
        </motion.div>
              ...
              <div className="relative w-[280px] md:w-[320px] aspect-[9/19] rounded-[3rem] bg-[var(--text-primary)] p-3 shadow-[0_30px_80px_rgba(0,0,0,0.25)]">
                ...
                <div className="relative w-full h-full rounded-[2.3rem] bg-[var(--bg-primary)] overflow-hidden flex flex-col">
                  ...
                  <div className="flex-1 px-5 py-4 space-y-3 overflow-hidden">
                    {[
                      { label: 'Café Noisette', price: '2,80 €' },
                      { label: 'Croissant Beurre', price: '1,90 €' },
                      { label: 'Tartine Avocat', price: '6,50 €' },
                      { label: 'Smoothie Mangue', price: '5,20 €' },
                      { label: 'Salade César', price: '11,90 €' },
                    ].map((item) => (
                      <div
                        key={item.label}
