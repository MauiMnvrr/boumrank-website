 ...
 * l'ID dans data-pixel-id. Ne s'initialise que si le consentement 'ads' est
 * accordé. Si l'accord arrive APRÈS le chargement (clic bannière), on écoute
 * 'boumrank-consent-update' et on initialise alors, sans rechargement. Sinon inerte.
 */
(function () {
  ...
  function initPixel() {
    if (window.ttq) return; // idempotent : déjà initialisé
